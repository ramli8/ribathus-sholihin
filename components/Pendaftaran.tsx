      ...
      <div className="container px-4 sm:px-6 mx-auto max-w-7xl relative z-10">
        ...
        >
          ...
          <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6 font-heading tracking-tight">
            Langkah Awal Menuju <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400">Masa Depan Gemilang</span>
          </h3>
          ...
          >
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-start gap-3 text-slate-600 dark:text-slate-300 font-light text-base group/item">
            ...
            <div className="relative z-10">
              ...
              <div className="relative border-l-2 border-slate-700/50 dark:border-slate-600/50 pl-6 space-y-8 py-2">
                {[
                  ...
                  <div key={i} className="relative text-slate-300 font-light text-base group/step">
                    ...
                    <span className="block leading-snug group-hover/step:text-white transition-colors">{item}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="flex justify-between items-center p-4 rounded-2xl bg-white/50 dark:bg-slate-800/40 backdrop-blur-md border border-white/40 dark:border-white/5 hover:bg-white dark:hover:bg-slate-800/80 transition-colors group/item">
                  <span className="text-slate-600 dark:text-slate-400 font-light group-hover/item:text-slate-800 dark:group-hover/item:text-slate-200 transition-colors">{item.label}</span>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
              ...
              <div className="text-center lg:text-left max-w-xl">
                ...
                <p className="text-emerald-50/90 font-light text-base md:text-lg leading-relaxed">
                  Pendaftaran online disarankan agar proses verifikasi lebih cepat, akurat, dan transparan bagi semua pihak.
                </p>
              </div>
              
              <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto flex-shrink-0">
                <button className="flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white font-semibold hover:bg-white/20 transition-all duration-300 w-full lg:w-auto">
                  <Download size={18} /> Unduh Brosur
                </button>
                <button className="group/btn flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-white text-emerald-900 font-bold hover:bg-slate-50 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all duration-300 w-full lg:w-auto">
                  Isi Formulir Online
